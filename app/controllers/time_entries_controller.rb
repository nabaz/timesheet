class TimeEntriesController < ApplicationController
  ...
  def create
    ...
    @time_entry = TimeEntryForm.new(time_entry_params)
    @time_entry.user = current_user
    if @time_entry.save
      redirect_to time_entries_url, notice: "Time entry has been created"
    else
      render :new
    end
  end
  ...
  private
    ...
    def time_entry_params
      params.require(:time_entry_form).permit(:title, :task, :user, :start_time, :end_time, :description, :location)
    end
end
